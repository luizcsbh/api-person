...
class UpdatePessoaRequest extends FormRequest
{
    ...
    {
        return [
            'pes_nome' => 'sometimes|required|string|max:200|min:3',
            'pes_data_nascimento' => 'sometimes|required|date',
            'pes_sexo' => 'sometimes|required|string|max:9',
            'pes_mae' => 'sometimes|required|string|max:200|min:3',
            'pes_pai' => 'sometimes|required|string|max:200|min:3',
        ];
    }
